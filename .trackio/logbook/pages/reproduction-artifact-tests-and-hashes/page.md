# Reproduction, artifact, tests, and hashes


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_8e0ce2d00644", "created_at": "2026-07-16T15:30:28+00:00", "title": "Fail-closed CPU reproduction"}
-->
# Reproduce locally
...
The full numerical run takes about **5.12 seconds** on the recorded local CPU. It writes all raw CSVs, source audit, environment record, plot and summary from scratch.
...
Artifact reference: `flat-minima-sco-repro/flat-minima-cpu-reproduction:v0`


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_29945745f86e", "created_at": "2026-07-16T15:30:28+00:00", "title": "Complete CPU reproduction workspace", "artifact": "flat-minima-sco-repro/flat-minima-cpu-reproduction:v0", "artifact_type": "dataset"}
-->
**📦 Artifact** `flat-minima-sco-repro/flat-minima-cpu-reproduction:v0` · dataset

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#flat-minima-sco-repro/flat-minima-cpu-reproduction:v0


---
<!-- trackio-cell
{"type": "code", "id": "cell_01719ec74586", "created_at": "2026-07-16T15:30:59+00:00", "title": "Full CPU reproduction command", "command": [".venv/bin/python", "repro/src/reproduce_flat_minima.py"], "exit_code": 0, "duration_s": 5.524}
-->
````bash
$ .venv/bin/python repro/src/reproduce_flat_minima.py
````
...
11 output files detected; recording the 10 largest.


````python title=reproduce_flat_minima.py
#!/usr/bin/env python3
...
{"boundaries": {"saerm_rho_one_outside_theorem_population_gap": 0.0, "sagd_r_equals_rho_max_risk": 0.0, "sagd_violated_threshold_max_risk": 0.0, "sam_r_zero_sharpness_gap": 0.0}, "claim_1_saerm": {"accepted_datasets": 48, "all_flat_saer_global_minima": true, "all_sharp_growth_ratios": true, "certificate_rows": 576, "dimensions": [65, 257, 1025], "event_trials": 16384, "max_event_probability_abs_error": 0.01684941325609257, "max_mc_z_score": 3.0288107985983395, "min_flat_population_risk_rho_le_half": 0.0625, "sharp_growth_rows": 16, "status": "supported by exact theorem-instance certificates and finite event trials", "theorem_floor": 0.0625}, "claim_2_sagd": {"T_values": [64, 128, 256, 512, 1024], "all_theorem_conditions": true, "boundary_controls": [{"T": 64, "boundary": "r_equals_rho", "eta": 0.25, "max_suffix_population_risk": 0.0, "min_suffix_population_risk": 0.0, "radius_r": 0.1, "rho": 0.1, "rho_threshold": 0.04000000000000001, "theorem_lower_conditions_hold": false}, {"T": 64, "boundary": "rho_threshold_violated", "eta": 0.25, "max_suffix_population_risk": 0.0, "min_suffix_population_risk": 0.0, "radius_r": 0.5, "rho": 0.4, "rho_threshold": 0.2, "theorem_lower_conditions_hold": false}], "dimensions_up_to": 65536, "max_iterate_norm": 0.9995115994824673, "min_population_to_lower_scale": 0.05536138142732779, "min_suffix_population_risk_range": [0.05536138142732779, 0.05686493335706602], "saer_times_T_range": [7.9999999999999964, 8.0], "status": "supported by exact tie-broken trajectories and every suffix average", "suffixes_checked": 1984}, "claim_3_sam": {"T_values": [16, 32, 64, 128], "accepted_iid_datasets_per_scale": 10, "all_radius_conditions": true, "all_source_dynamic_gates": true, "dimensions": [1025, 2049, 4097, 8193], "fixed_r_min_certificate_to_scale": 0.058735084726612416, "full_runs": 80, "max_iterate_norm": 0.4821178776807705, "max_wstar_empirical_risk": 0.0, "same_r2_T_exponents_in_stability_upper": true, "saturated_min_certificate_to_scale": 0.05873508472661239, "saturated_min_population_certificate_range": [0.014683771181653097, 0.018994738307047777], "sharp_gap_ratio_nonzero_r": [0.5], "sharpness_rows": 54, "stability_scope": "same r^2*T dependence; the paper explicitly says nearly matches, up to eta (and beta normalization), not constant-tight", "stability_upper_to_lower_scale_ratio": [864.0], "status": "supported by exact 1D sharpness and full high-dimensional source construction", "suffixes_checked": 4800}, "environment": {"cloud_jobs": 0, "cpu_brand": "unknown", "cpu_only": true, "cuda_visible_devices": "", "external_model_calls": 0, "float_dtype": "float64", "gpu_used": false, "machine": "x86_64", "matplotlib": "3.11.0", "mps_used": false, "network_calls_during_reproduction": 0, "numpy": "2.5.1", "paid_api_calls": 0, "platform": "Linux-7.0.9-arch2-1-x86_64-with-glibc2.43", "python": "3.12.13 (main, Jun 23 2026, 15:18:55) [Clang 22.1.3 ]", "wall_seconds": 4.937872854061425}, "identity": {"arxiv_id": "2511.03548", "automatic_claims": 3, "live_claims": 4, "openreview_id": "u6zp8zZ8Ou", "title": "Flat Minima and Generalization: Insights from Stochastic Convex Optimization"}, "scope": {"conditional_event_sampling_disclosed": true, "official_code_executed": false, "reason": "no official executable code accompanies the supplied arXiv source snapshot", "source_audit_separated_from_execution": true, "theorem_instances_not_proxy_tasks": true, "universal_proof_claimed": false}}
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_5a409c4f82ae", "created_at": "2026-07-16T15:30:59+00:00", "title": "Artifact: sam_generalization_suffixes.csv", "path": "outputs/full/sam_generalization_suffixes.csv", "size": 691449, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sam_generalization_suffixes.csv` · dataset · 0.7 MB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sam_generalization_suffixes.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_79e283ff4ef0", "created_at": "2026-07-16T15:30:59+00:00", "title": "Artifact: sagd_suffix_dynamics.csv", "path": "outputs/full/sagd_suffix_dynamics.csv", "size": 275764, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sagd_suffix_dynamics.csv` · dataset · 0.3 MB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sagd_suffix_dynamics.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_04712dce2438", "created_at": "2026-07-16T15:30:59+00:00", "title": "Artifact: saerm_flat_sharp_trials.csv", "path": "outputs/full/saerm_flat_sharp_trials.csv", "size": 78630, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/saerm_flat_sharp_trials.csv` · dataset · 78.6 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/saerm_flat_sharp_trials.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_92c448577bbb", "created_at": "2026-07-16T15:30:59+00:00", "title": "Artifact: sam_generalization_runs.csv", "path": "outputs/full/sam_generalization_runs.csv", "size": 21204, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sam_generalization_runs.csv` · dataset · 21.2 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sam_generalization_runs.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_a530b9ba446d", "created_at": "2026-07-16T15:31:00+00:00", "title": "Artifact: sam_sharpness.csv", "path": "outputs/full/sam_sharpness.csv", "size": 4286, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sam_sharpness.csv` · dataset · 4.3 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sam_sharpness.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_6fcb7e712de5", "created_at": "2026-07-16T15:31:00+00:00", "title": "Artifact: stability_scaling.csv", "path": "outputs/full/stability_scaling.csv", "size": 2176, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/stability_scaling.csv` · dataset · 2.2 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/stability_scaling.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_34c85b19ded1", "created_at": "2026-07-16T15:31:00+00:00", "title": "Artifact: sam_construction_parameters.csv", "path": "outputs/full/sam_construction_parameters.csv", "size": 1569, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sam_construction_parameters.csv` · dataset · 1.6 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sam_construction_parameters.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_63a4ed18359f", "created_at": "2026-07-16T15:31:00+00:00", "title": "Artifact: saerm_sharpness_certificate.csv", "path": "outputs/full/saerm_sharpness_certificate.csv", "size": 1389, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/saerm_sharpness_certificate.csv` · dataset · 1.4 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/saerm_sharpness_certificate.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_790d301ff883", "created_at": "2026-07-16T15:31:00+00:00", "title": "Artifact: sagd_scaling.csv", "path": "outputs/full/sagd_scaling.csv", "size": 1363, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/sagd_scaling.csv` · dataset · 1.4 kB

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/sagd_scaling.csv


---
<!-- trackio-cell
{"type": "artifact", "id": "cell_f8630572a360", "created_at": "2026-07-16T15:31:01+00:00", "title": "Artifact: event_probabilities.csv", "path": "outputs/full/event_probabilities.csv", "size": 836, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/full/event_probabilities.csv` · dataset · 836 B

https://huggingface.co/buckets/DineshAI/u6zp8zZ8Ou-artifacts#logbook-files/outputs/full/event_probabilities.csv


---
<!-- trackio-cell
{"type": "code", "id": "cell_c668da57a6c2", "created_at": "2026-07-16T15:31:01+00:00", "title": "Fail-closed verification: 15/15 tests", "command": [".venv/bin/python", "repro/src/verify_all.py"], "exit_code": 0, "duration_s": 0.131}
-->
````bash
$ .venv/bin/python repro/src/verify_all.py
````
...
````output
test_01_identity_and_exact_claim_snapshot (test_reproduction.FlatMinimaReproductionTests.test_01_identity_and_exact_claim_snapshot) ... ok
test_02_paper_and_source_are_pinned (test_reproduction.FlatMinimaReproductionTests.test_02_paper_and_source_are_pinned) ... ok
test_03_hard_event_frequencies_match_exact_probabilities (test_reproduction.FlatMinimaReproductionTests.test_03_hard_event_frequencies_match_exact_probabilities) ... ok
test_04_saerm_exact_flat_sharp_separation (test_reproduction.FlatMinimaReproductionTests.test_04_saerm_exact_flat_sharp_separation) ... ok
test_05_sharp_minimum_saturates_smoothness_growth (test_reproduction.FlatMinimaReproductionTests.test_05_sharp_minimum_saturates_smoothness_growth) ... ok
test_06_sagd_all_conditions_and_unit_ball (test_reproduction.FlatMinimaReproductionTests.test_06_sagd_all_conditions_and_unit_ball) ... ok
test_07_sagd_saer_is_exactly_order_one_over_T (test_reproduction.FlatMinimaReproductionTests.test_07_sagd_saer_is_exactly_order_one_over_T) ... ok
test_08_sagd_population_risk_is_constant_and_scales_as_lower_bound (test_reproduction.FlatMinimaReproductionTests.test_08_sagd_population_risk_is_constant_and_scales_as_lower_bound) ... ok
test_09_sagd_boundary_controls_remove_the_gap (test_reproduction.FlatMinimaReproductionTests.test_09_sagd_boundary_controls_remove_the_gap) ... ok
test_10_sam_one_dimensional_sharpness_is_exact (test_reproduction.FlatMinimaReproductionTests.test_10_sam_one_dimensional_sharpness_is_exact) ... ok
test_11_full_sam_construction_dynamic_gates (test_reproduction.FlatMinimaReproductionTests.test_11_full_sam_construction_dynamic_gates) ... ok
test_12_full_sam_every_suffix_has_nontrivial_lower_certificate (test_reproduction.FlatMinimaReproductionTests.test_12_full_sam_every_suffix_has_nontrivial_lower_certificate) ... ok
test_13_stability_upper_matches_r2_T_exponents_with_disclosed_eta_gap (test_reproduction.FlatMinimaReproductionTests.test_13_stability_upper_matches_r2_T_exponents_with_disclosed_eta_gap) ... ok
test_14_scope_is_finite_theorem_instance_not_universal_proof (test_reproduction.FlatMinimaReproductionTests.test_14_scope_is_finite_theorem_instance_not_universal_proof) ... ok
test_15_cpu_only_no_external_compute (test_reproduction.FlatMinimaReproductionTests.test_15_cpu_only_no_external_compute) ... ok

----------------------------------------------------------------------
Ran 15 tests in 0.042s

OK
PASS: 15 independent assertions; CPU-only theorem-instance reproduction verified
